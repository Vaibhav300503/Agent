        ...
        for protocol in ['tcp', 'udp']:
            ...
            try:
                ...
                for line in lines:
                    ...
                    # Override IPs extracted from message with precise ones from network data
                    processed_log['source_ip'] = local_ip
                    processed_log['dest_ip'] = remote_ip
                    
                    self.send_log(processed_log['message'], processed_log)
            except Exception as e:
    ...
    def _collect_windows(self):
        ...
        try:
            ...
            for line in output.splitlines():
                ...
                processed_log = self.processor.process(raw_data)
                # Override IPs extracted from message with precise ones from network data
                processed_log['source_ip'] = l_ip
                processed_log['dest_ip'] = r_ip
